...
namespace _102200311_TranNhatMinh.GUI
{
    public partial class MainForm : Form
    {
        ...
        private void ShowData(string str = "")
        {
            ...
            dataGridViewQLSV.DataSource = BLLQLSV.Instance.GetSVHP_ViewByidHP(id_HP);
            dataGridViewQLSV.Columns["_IDSV"].Visible = false;
            dataGridViewQLSV.Columns["_IDHP"].Visible = false;
            dataGridViewQLSV.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            dataGridViewQLSV.Columns[3].HeaderCell.Value = "Tên SV";
            dataGridViewQLSV.Columns[4].HeaderCell.Value = "Lớp SH";
            dataGridViewQLSV.Columns[5].HeaderCell.Value = "Tên học phần";
            dataGridViewQLSV.Columns[6].HeaderCell.Value = "Điểm BT";
            dataGridViewQLSV.Columns[7].HeaderCell.Value = "Điểm GK";
            dataGridViewQLSV.Columns[8].HeaderCell.Value = "Điểm CK";
            dataGridViewQLSV.Columns[9].HeaderCell.Value = "Tổng kết";
            dataGridViewQLSV.Columns[10].HeaderCell.Value = "Ngày thi";
        }
        ...
        private void buttonEdit_Click(object sender, EventArgs e)
        {
            if (dataGridViewQLSV.SelectedRows.Count == 1)
            {
                ...
                string mshp = dataGridViewQLSV.SelectedRows[0].Cells[1].Value.ToString();
                DetailForm f = new DetailForm(mssv, mshp);
                f.delOK = ShowData;//delegate
                f.delChangeButtonState = changeStateButton;
                f.Show();
                changeStateButton();
        ...
        private void buttonDel_Click(object sender, EventArgs e)
        {
            if (dataGridViewQLSV.SelectedRows.Count > 0)
            {
                ...
                if (dialogResult == DialogResult.OK)
                {
                    ...
                    BLLQLSV.Instance.DeleteSVHP(mssv, mshp);
                    ShowData();
                }
            }
        }
